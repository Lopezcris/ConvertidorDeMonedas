package com.facci.conversorclm;
...
public class MainActivityCLM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        monedaActualSP = (Spinner) findViewById(R.id.monedaCambioSP);
    ...
    public void clickConvertir(View v) {
        ...
        if (resultado > 0) {
            ...
            Toast.makeText(MainActivityCLM.this, "Las opciones elegidas no tienen un factor de conversión", Toast.LENGTH_SHORT).show();
        }
    }
